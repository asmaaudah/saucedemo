...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_firstName'), 'Asma')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_lastName'), 'Audah')
...
WebUI.verifyElementVisible(findTestObject('Page_Swag Labs/span_Checkout Complete'))
